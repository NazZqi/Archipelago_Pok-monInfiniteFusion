    ...
    def do_POST(self):
        if self.path == "/event":
            try:
                ...
                if msg_type in ["item_found", "item_received", "pokemon_caught", "pokemon_received", "trainer_defeated"]:
            ...
            if "data" in args:
                ...
                for p in args["data"]:
                    ...
                    if t == "player_id":
                        try:
                            player = int(text)
                            parts.append(self.player_names[player] if player in getattr(self, "player_names", {}) else text)
                        except:
                            parts.append(text)
                    elif t == "item_id":
                        try:
                            ...
                            if item in ITEM_DICTIONARY:
                                parts.append(ITEM_DICTIONARY[item]["name"])
                            elif hasattr(self, "item_names"):
                                parts.append(self.item_names.lookup_in_game(int(text)))
                            else:
                                parts.append(text)
                        except:
                            parts.append(text)
                        ...
                        try:
                            ...
                            if hasattr(self, "location_names"):
                                parts.append(self.location_names.lookup_in_game(int(text)))
                            else:
                                parts.append(text)
                        except:
                            parts.append(text)
